...
def run_linear_regression(X_train, X_test, y_train, y_test):
    ...
    r2, rmse, mae = _evaluate_regression(y_test, y_pred)
...
def run_random_forest(X_train, X_test, y_train, y_test):
    ...
    print(f"\n Variables importances RF saved in : {rf_path}")
...
def run_xgboost(X_train, X_test, y_train, y_test):
    ...
    print(f"\n Variables importances XGBoost saved in : {xgb_imp_path}")
